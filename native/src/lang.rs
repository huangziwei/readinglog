...
pub struct Strings {
    ...
    pub yes: &'static str,
    pub no: &'static str,
    /// The Graphs tab's bands, one heading each. `the_clock` names its
...
const ENGLISH: Strings = Strings {
    ...
    yes: "yes",
    no: "no",
    read_through_band: "READ THROUGH",
    the_days: "THE DAYS",
...
const GERMAN: Strings = Strings {
    ...
    yes: "ja",
    no: "nein",
    read_through_band: "GANZ GELESEN",
    the_days: "DIE TAGE",
