...
pub struct Strings {
    ...
    pub reread_from_beginning: &'static str,
    pub yes: &'static str,
...
const ENGLISH: Strings = Strings {
    ...
    reread_from_beginning: "Reread from beginning",
    yes: "yes",
...
const GERMAN: Strings = Strings {
    ...
    reread_from_beginning: "Von vorn lesen",
    yes: "ja",
