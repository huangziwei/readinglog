...
pub struct Strings {
    ...
    /// How many times a book has been read end to end, and its figure.
    pub read_through_row: &'static str,
    pub n_times: &'static str,
    ...
    pub yes: &'static str,
    pub no: &'static str,
    /// The Graphs tab's bands. `read_through_band` counts the book's readings
    /// and `nth_reading` names the one drawn; `{d}` is filled by [`counted`],
    /// and the clock names its fullest hour after `most`.
    pub read_through_band: &'static str,
    ...
    pub kind_highlight: &'static str,
    pub kind_note: &'static str,
    pub kind_article: &'static str,
    pub kind_underline: &'static str,
    pub kind_circle: &'static str,
    pub kind_asterisk: &'static str,
    ...
    pub color_schemes: [&'static str; 4],
...
const ENGLISH: Strings = Strings {
    ...
    yes: "yes",
    no: "no",
    read_through_band: "READ THROUGH · {d}",
    the_days: "THE DAYS",
    where_you_sat: "WHERE YOU SAT",
    nth_reading: "READ THROUGH {d}",
    the_clock: "THE CLOCK",
    ...
    color_schemes: ["Brown", "Green", "Indigo", "Grey"],
    size_small: "Small",
    size_medium: "Medium",
    size_large: "Large",
...
const GERMAN: Strings = Strings {
    ...
    yes: "ja",
    no: "nein",
    read_through_band: "GANZ GELESEN · {d}",
    the_days: "DIE TAGE",
    where_you_sat: "WO DU WARST",
    nth_reading: "{d}. DURCHGANG",
    ...
    kind_underline: "Unterstreichung",
    kind_circle: "Kreis",
    kind_asterisk: "Sternchen",
    kind_other: "Markierung",
    read: "gelesen",
    left: "übrig",
    ...
    color_schemes: ["Braun", "Grün", "Indigo", "Grau"],
    size_small: "Klein",
    size_medium: "Mittel",
    size_large: "Groß",
...
mod tests {
    ...
    fn a_counted_template_takes_the_ending_that_goes_with_its_number() {
        ...
        for lang in Lang::ALL {
            let s = lang.strings();
            for said in [s.since_days, s.read_through_band, s.nth_reading] {
                for n in [1, 30] {
